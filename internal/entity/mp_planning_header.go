...
type MPPlanningHeader struct {
	...
	EmpOrganizationID *uuid.UUID      `json:"emp_organization_id" gorm:"type:char(32);not null;"`
	...
	RecommendedBy     *uuid.UUID      `json:"recommended_by" gorm:"type:char(32);"`
	ApprovedBy        *uuid.UUID      `json:"approved_by" gorm:"type:char(32);"`
	RequestorID       *uuid.UUID      `json:"requestor_id" gorm:"type:char(32);"`
